...
require("lazy").setup({
    spec = {
        ...
        -- disable conform.nvim due to annoying formatting
...

        {
            ...
            keys = {
                ...
                },
                {
                    ...
                    -- not fuzzy find by grepping in project directory
                },
                {
                    "<leader>fp",
                    function()
                    ...
                    desc = "(fuzzy) find by running ripgrep in project directory",
                    -- fuzzy find by running ripgrep in project directory
                },
                {
                    "<leader>fc",
                    function()
                ...
                },
                {
                    ...
                    desc = "[f]ind current [W]ord",
                    -- find current word in uppercase
                },
                {
                    "<leader>fd",
                    function()
