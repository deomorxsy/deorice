-- -- ### -- uncomment for bringing back
-- -- ### -- lsp-zero dependency: it goes against the dead project statement by
-- -- ### -- lsp-zero repository itself
-- -- ### --
-- -- ### -- todo: adjust with a compatibility layer (shim-like) only using vim.lsp.config
...
-- -- ### 		vim.diagnostic.open_float(nil, { scope = "line", header = false, focus = false })
-- -- ### 	end)
-- -- ###
...
-- -- ### vim.lsp.handlers["textDocument/publishDiagnostics"] = vim.lsp.buf.definition({
